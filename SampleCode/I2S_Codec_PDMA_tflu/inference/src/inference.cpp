...
//InferenceJob::InferenceJob(const string &_name,const vector<DataPtr> &_input, const size_t _numBytesToPrint) :
//    name(_name)
//     {}			
			 
InferenceJob::InferenceJob(const string &_name, const uint8_t test){}		
